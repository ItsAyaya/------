...
export const locations: Location[] = [
  {
    id: 1, name: '项大娘米线', category: '米线', stars: 2,
    photos: photosFrom(1, 1, ['金黄酥香的现烤面包']),
    reviewerName: '灵梦', reviewerAvatar: getAvatar('lingmeng'),
    reviewText: '新开那家项大娘米线挺好吃的。抖音9.9一张券，一碗米线+酸角汁，然后去小料台猛猛加料就完事了',
    address: '威海市环翠区火炬高新技术产业开发区怡园街道文化西路38号-21', mapKeyword: '文化西路',
  },
  {
    id: 2, name: '大服一楼面包店', category: '面包·烘焙', stars: 3,
    photos: photosFrom(2, 7, ['半熟芝士', '奶油面包', '抹茶菠萝包', '面包柜', '奶油面包细节','海盐芝士软欧', '软欧细节',]),
    reviewerName: '灵梦', reviewerAvatar: getAvatar('lingmeng'),
    reviewText: 'p1半熟芝士五块钱，据店主说是面粉比较多的半熟芝士。外层有些芝士味，内部更接近于湿一些的戚风蛋糕。考虑到只卖五块钱，性价比还是比较高。p2-p5奶油面包+抹茶菠萝包，17r。两种面包内馅均为动物奶油，吃起来香而不甜。抹茶菠萝包抹茶味较浓，内部的奶油馅里还有些许红豆，锦上添花。两种面包都好吃。p6-p7海盐芝士软欧8r，麦香浓郁，松软咸香，一层微焦的深色脆壳提供了脆感与焦香。大量的芝士酱味道厚重，甚至喧宾夺主，吃到最后会很腻。我觉得去掉芝士酱会更好吃。',
    address: '哈工大威海校区大服一楼', mapKeyword: '哈工大威海大学生服务楼',
  },
  {
    id: 3, name: '学子一楼面包店', category: '面包·烘焙', stars: 3,
    photos: photosFrom(3, 5, [ '菠萝包', '菠萝包外观', '抹茶红豆', '内部组织', '整体展示']),
    reviewerName: '灵梦', reviewerAvatar: getAvatar('lingmeng'),
    reviewText: '菠萝包和抹茶红豆一共16r。菠萝包的卖相惊艳，外壳酥松，甜度正好，黄油香浓郁。内部的巨大气孔使得它吃起来相当松软。单纯从技巧角度，它远超大服一楼的菠萝包。抹茶红豆一般，抹茶味太淡，全被红豆掩盖了。',
  ...
  },
  {
    ...
    address: '威海市环翠区文化西路与德州中街交叉口东南160米', mapKeyword: '文化西路',
  },
  {
    id: 5, name: '80后考场', category: '烧烤', stars: 2,
    photos: [],
    reviewerName: '灵梦', reviewerAvatar: getAvatar('lingmeng'),
    reviewText: '我晚上吃的这家，辣炒蚬子一盘8块，有点牛逼。',
    address: '威海市环翠区塔山中路与路安街交叉口西北200米', mapKeyword: '塔山中路',
  },
  {
    id: 6, name: '香格里拉菌王府', category: '中餐·菌菇', stars: 2,
    photos: photosFrom(6, 13, ['松茸汽锅鸡', '汽锅鸡汤色', '松茸狮子头', '狮子头', '牛肝菌砂锅山药', '山药挂汁', '苦荞饼', '柠檬树蝶花', '米饭', '店内装潢', '一楼养生品区', '外观门面', '菜单',]),
    //先减少一张图片，保证评论完整
    reviewerName: '灵梦', reviewerAvatar: getAvatar('lingmeng'),
    ...
    address: '威海市环翠区高区文化西路193-1号', mapKeyword: '文化西路',
  },
  {
    ...
    address: '威海市环翠区高区青州南街12号富贵园', mapKeyword: '板面羊杂面',
  },
  {
    ...
    address: '威海市环翠区哈工大青州南街12-14号', mapKeyword: '阿朱腊汁肉夹馍',
  },
  {
    ...
    address: '威海市环翠区青州街134-9号', mapKeyword: '威海帝王宫衢州鸭头',
  },
  {
    ...
    address: '威海市环翠区张村镇皂南台2号公寓', mapKeyword: '威海张村冯家全羊',
  },
  {
  ...
  {
    id: 13, name: '里口山铜火锅', category: '火锅', stars: 2,
    photos: photosFrom(13, 1, ['铜火锅与肉']),
    reviewerName: 'pepsi', reviewerAvatar: getAvatar('pepsi'),
    reviewText: '味道还行，88r两斤肉，肉质很鲜嫩而且价格实惠😋',
    address: '威海市环翠区田和街道洪福庄园31-102综合楼一层南3号', mapKeyword: '铜火锅',
  },
  {
    id: 14, name: '兰州牛肉拉面·大盘鸡', category: '清真·面食·烧烤', stars: 2,
    photos: photosFrom(14, 2, ['店面', '羊肉串与拉面']),
    reviewerName: '五海', reviewerAvatar: getAvatar('wuhai'),
    ...
    address: '威海市环翠区怡园街道德州中街金海滩花园9-3-8', mapKeyword: '兰州牛肉拉面·大盘鸡',
  },
  {
    id: 15, name: '田野冰屋', category: '甜品·冰品', stars: 2,
    photos: photosFrom(15, 5, ['芒果牛奶冰', '抹茶刨冰', '松饼', '店内环境', '海水浴场风景', '门面']),
    reviewerName: '雨草', reviewerAvatar: getAvatar('yucao'),
    ...
    address: '威海市环翠区高区国际海水浴场北环海路165-1-107', mapKeyword: '田野冰屋',
  },
]
